...
include('../../config/config.php');
	...
	if(isset($_POST['save'])){
		...
		for($i=0;$i<$jlh2;$i++){
			$sql4="INSERT INTO detail_st_menimbang SET id_sk='$id_sk', menimbang='$menimbang[$i]'";
			$query4=mysql_query($sql4) or die(mysql_error());
		}
		
		$jlh3 = count($dasar); 
		for($i=0;$i<$jlh3;$i++){
			$sql5="INSERT INTO detail_st_dasar SET id_sk='$id_sk', dasar='$dasar[$i]'";
