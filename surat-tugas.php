...
<table style="height: 50px; width: 812px;" >
    ...
    <?php 
		$tugas = "SELECT * FROM pegawai, detail_st WHERE `detail_st`.`id_sk` = '$id' and `detail_st`.`petugas_nip` = `pegawai`.`nip` ORDER BY `detail_st`.`id` ASC ";
...
<td style="width: 633px; height: 13px;"><?php echo $tujuan_st; ?></td>
</tr>
<tr style="height: 13px;">
<td style="width: 140px; height: 13px;">Tempat</td>
<td style="width: 18px; height: 13px;">:</td>
<td style="width: 633px; height: 13px;"><?php echo $tempat_st; ?></td>
</tr>
<tr style="height: 13px;">
...
<tr style="height: 13px;">
<td style="width: 140px; height: 13px;" valign="top" align="left">Biaya</td>
<td style="width: 18px; height: 13px;" valign="top">:</td>
<td style="width: 633px; height: 13px;" valign="top" align="left"><?php 
...
<td style="width: 249.8px; text-align: left;"><?php 
        			...
        			echo 'Plt. Kepala Balai Pengawas Obat dan Makanan di Jambi';}
                    else if ($level != 1){
                    echo 'Plh. Kepala Balai Pengawas Obat dan Makanan di Jambi'; 
                    }
                    ?></td>
</tr>
<tr>
