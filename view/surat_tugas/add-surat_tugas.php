            ...
            <div class="row">
                <form action="sql/surat_tugas/add.php" method="POST">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        ?>
                        <input type="hidden" class="form-control" id="formfield4" name="pembuat" value="<?= $_SESSION['username']; ?>">
                        <div class="form-group">
                            <label class="form-label" for="formfield1">Id Surat Keluar</label>
                            <span class="desc">e.g. "0001"</span>
                            <div class="controls">
                                <input type="text" class="form-control" id="formfield1" name="id_sk" required="required" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <table id="Menimbang" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="95%">
                                            <textarea class="form-control" name="menimbang[]" required></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" id="id" name="mak" placeholder="Ketik MAK" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <table id="Nama Anggaran2" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        <td width="5%"><input type="radio" name="dipa_pusat" value="Ya"> Ya</td>
                                    </tr>
                                    <tr>
                                        <td width="5%"><input type="radio" name="dipa_pusat" value="Tidak"> Tidak</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control" id="formfield4" name="tempat_tugas">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control" id="formfield4" name="kegiatan">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="tanggal_berangkat">Tanggal Berangkat</label>
                            <input type="text" class="form-control" id="tanggalberangkat" name="tanggal_berangkat" required>
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="tanggal_kembali">Tanggal Kembali</label>
                            <input type="text" class="form-control" id="tanggalkembali" name="tanggal_kembali" required>
                        </div>
