                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group">
                       ...
                       <select name="provinsi" id="provinsi" class="form-control">
                            ...
                            $sql = $pdo->prepare("SELECT * FROM surat_tugas WHERE status='belum_sppd' AND pembuat = '$user_login' ORDER BY id_sk");
                    ...
                    <div class="form-group">
                        ...
                        <span class="desc pull-right">
                                <a class="btn btn-default btn-sm" onClick="addRow('Petugas')"><i class="fa fa-plus"></i></a>
                                <a class="btn btn-default btn-sm" onClick="deleteRow('Petugas')"><i class="fa fa-trash"></i></a>
                        </span>
                        <table id="Petugas" width="100%" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td width="25%">
                                    <input type="text" class="form-control" id="formfield3" name="no_sppd[]" placeholder="Nomor SPPD" required >
                                </td>
                                <td width="25%">
