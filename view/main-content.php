    ...
    <section class="wrapper main-wrapper" style=''>
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <h1 class="title"></h1>
                    <h3 class="title">CANDI</h3>                            
                    <h5 class="title">Catatan Perjalanan Dinas</h5>
                </div>
            </div>
        </div>
                                ...
                                <div class="r4_counter db_box">
                                    <i class='pull-left fa fa-envelope icon-md icon-rounded icon-warning'></i>
                                        <div class="stats">
                                            ...
                                            <span>PERTANGGUNGJAWABAN DALAM KOTA</span>
                                        </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="r4_counter db_box">
                                    <i class='pull-left fa fa-users icon-md icon-rounded icon-danger'></i>
                                        <div class="stats">
                                            ...
                                            <span>PERTANGGUNGJAWABAN LUAR KOTA</span>
                                        </div>
                                </div>
                            </div>                    
                    </div> <!-- End .row -->    
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="r3_notification db_box">
                                ...
                                <?php 
                                    ...
                                    $sql = "SELECT * FROM surat_tugas WHERE pembuat = '$user_login' ORDER BY id_sk DESC LIMIT 10";
