                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group">
                       ...
                       <select name="provinsi" id="provinsi" class="form-control">
                            ...
                            $sql = $pdo->prepare("SELECT * FROM surat_tugas WHERE jenis_st = 'dalam_kota_tidak_sppd' AND pembuat='$user_login' AND id_sk NOT IN (SELECT id_sk FROM ptj_dlm_kota) ORDER BY id_sk");
