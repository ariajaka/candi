                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="cetak" onchange="window.open(this.options[this.selectedIndex].value, '_blank')" class="btn btn-success btn-sm">
                                    ...
                                    <option value="cetak/kota/spby_kota.php?id=<?php echo $data_surtu['id_pk']; ?>">SPBy</option>
                                    <option value="cetak/kota/kuitansi_kota.php?id=<?php echo $data_surtu['id_pk']; ?>">Kuitansi</option>
                                    <option value="cetak/kota/nominatif_kota.php?id=<?php echo $data_surtu['id_pk']; ?>">Nominatif</option>
                                    <option value="cetak/kota/riil_kota.php?id=<?php echo $data_surtu['id_pk']; ?>">Rill</option> 
