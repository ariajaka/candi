...
<tbody>
  <tr>
    ...
    ?>
    <td style="width: 812px; text-align: left;">Berdasarkan Surat  Perjalanan Dinas (SPD) tanggal  <?= substr($tgl_st, 3,2).' '.$sebut.' '.substr($tgl_st, 6,4).'';?> Nomor : <?= $no_sppd; ?></td>
  </tr>
  <tr>
    <td style="width: 812px; text-align: left;">dengan ini kami menyatakan dengan sesungguhnya bahwa :</td>
  </tr>
</tbody>
</table>
...
<td style="width: 209px; height: 22px;">Mengetahui/Menyetujui</td>
...
<td style="width: 209px; height: 21px;">Yang Menerima</td>
</tr>
<tr style="height: 3px;">
