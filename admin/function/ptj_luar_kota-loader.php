            ...
            if (isset($_GET['id'])&&($_GET['id_pl'])) 
            {
                ...
                echo '<div class="panel panel-danger animated fadeInDownBig" id="notif" style="z-index:9999;position:absolute;margin:auto;background:rgb(42,42,42);color:white;margin-left:10%;margin-top:8%;">
                      ...
                      <center><div class="panel-body">
                        <p>Yakin ingin menghapus Pertanggungjawaban dalam Kota dengan Nomor SPPD '.$data['no_sppd'].' ?</p>
                        ...
                        <a class="btn btn-danger" href="sql/ptj_kota/delete.php?id='.$id.'&id_pl='.$id_pl.'" id="ya" id="hapus">YA</a>
        ...
        if ($akses == true) 
        {
            if (isset($_GET['id'])&&($_GET['id_pl'])) 
            {
                ...
                echo '<div class="panel panel-danger animated fadeInDownBig" id="notif" style="z-index:9999;position:absolute;margin:auto;background:rgb(42,42,42);color:white;margin-left:10%;margin-top:8%;">
                      <div class="panel-heading"><i class="fa fa-warning"><strong> Warning</strong></i></div>
                      <center><div class="panel-body">
                        <p>Yakin ingin memberi akses edit pada pertanggungjawaban luar kota nomor '.$data['id_pl'].' ?</p>
                        <p style="font-style:italic;font-size:12px;color:red"><i class="fa fa-warning"></i> Pembuat pertanggungjawaban luar kota dapat mengubah pertanggungjawabannya</p>
                        <a class="btn btn-danger" href="sql/ptj_luar_kota/akses.php?id='.$id.'&id_pl='.$id_pl.'" id="ya" id="akses">YA</a>
                        <button class="btn btn-success" id="tidak" onclick="$("#notif").hide();">TIDAK</button>
                      </div></center>
                    </div>';
        }
