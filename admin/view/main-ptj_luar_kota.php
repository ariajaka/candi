    ...
    <section class="wrapper main-wrapper" style=''>
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <!--
                    <h1 class="title">Pertanggungjawaban Luar Kota <a href="index.php?mod=ptj_luar_kota&act=add" class="btn btn-success"> Tambah Pertanggungjawaban Luar Kota</a></h1>    
                    -->                        
                </div>
            </div>
        </div>
        ...
        <?php include ('function/ptj_luar_kota-loader.php') ?>
