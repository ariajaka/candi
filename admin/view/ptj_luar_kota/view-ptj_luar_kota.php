                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="cetak" onchange="window.open(this.options[this.selectedIndex].value, '_blank')" class="btn btn-success btn-sm">
                                    ...
                                    <option value="spby_luar_kota.php?id=<?php echo $data_surtu['id_pl']; ?>">SPBy</option>
                                    <option value="kwitansi_luar_kota_up.php?id=<?php echo $data_surtu['id_pl']; ?>">Kuitansi</option>
                                    <option value="rincian_luar.php?id=<?php echo $data_surtu['id_pl']; ?>">Rincian</option>
                                    <option value="riil_luar.php?id=<?php echo $data_surtu['id_pl']; ?>">Rill</option>
                                    <option value="pernyataan_luar.php?id=<?php echo $data_surtu['id_pl']; ?>">Pernyataan</option> 
                                
                                </select>
                                
                                </form>
                                <?php if($status_ptj_luar_kota == 1):?>
                                <a href="index.php?mod=ptj_luar_kota&act=akses&id=<?php echo $data_surtu['id_pl']; ?>&id_pl=<?php echo $data_surtu['id_pl']; ?>" class="btn btn-primary btn-sm">Beri Akses Edit</a>                                
                                <?php endif ?>  
                                ...
                                <?php endif ?>
                                <!--
                                <a href="index.php?mod=ptj_luar_kota&act=edit&id=<?php echo $data_surtu['id_pl']; ?>" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i></a>
                                -->
