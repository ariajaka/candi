    ...
    <section class="wrapper main-wrapper" style=''>
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <!--
                    <h1 class="title">Pertanggungjawaban Dalam Kota <a href="index.php?mod=ptj_kota&act=add" class="btn btn-success"> Tambah Pertanggungjawaban Dalam Kota</a></h1>       
                    -->                     
                </div>
            </div>
        </div>
        ...
        <?php include ('function/ptj_kota-loader.php') ?>
