<?php 
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $editsql = "SELECT * FROM ptj_dlm_kota a INNER JOIN ptj_kota b ON a.id_pk=b.id_pk WHERE a.id_pk = '$id'";
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group">
                       ...
                       <select name="provinsi" id="provinsi" class="form-control">
                            <option value="<?php echo $penandas['id_sk'];?>"><?php echo $penandas['id_sk'];?>
                            <?php
