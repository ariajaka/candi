    ...
    <section class="wrapper main-wrapper" style=''>
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left">
                    <!--
                    <h1 class="title">Surat tugas <a href="index.php?mod=surat_tugas&act=add" class="btn btn-success"> Tambah Surat Tugas</a></h1>       
                    -->                     
                </div>
            </div>
        </div>
        ...
        <?php include ('function/surat_tugas-loader.php') ?>
