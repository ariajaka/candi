...
<?php include('../../sql/cetak-nominatif_kota.php'); ?>
<style>
  table {
...
<h4 style="text-align: center;">&nbsp;</h4>
<h4 style="text-align: center;">&nbsp;</h4>
<h4 style="text-align: center;">DAFTAR RINCIAN UANG TRANSPORT PETUGAS BALAI POM DI JAMBI</h4>
<?php
if (($tempat_st == "") || ($tempat_st == "-")) {
  $tempat_este =  " ";
} else if (($tempat_st != "") || ($tempat_st != "-")) {
  $tempat_este = 'DI ' . $tujuan_st;
}
?>


<h5 style="text-align: center;">BIAYA TRANSPORT LOKAL PETUGAS DALAM RANGKA <?= strtoupper($kegiatan); ?> <?= strtoupper($tempat_este); ?></h5>
<?php
...
?>
<h5 style="text-align: center;">TANGGAL, <?= strtoupper($sehari); ?></h5>
<p style="text-align: center;">&nbsp;</p>
<p style="text-align: justify;">MAK : <?= $mak; ?></p>
...
<table style="height: 50px; width: 812px;" border="#000000">
  ...
  <tbody>
    <tr>
      ...
      <td style="width: 228px; text-align: center;">Nama/NIP</td>
      <td style="width: 112px; text-align: center;">Jumlah Hari</td>
      <td style="width: 151px; text-align: center;">Di Bayar Per Hari</td>
      <td style="width: 157px; text-align: center;">Diterima</td>
      <td style="width: 157px; text-align: center;">Tanda Tangan</td>
    </tr>
    <?php
    $no = 0;
    ...
    ?>
      <tr>
        <td style="width: 48px; text-align: center;"><?= $no; ?></td>
        <td style="width: 228px; text-align: left;"><?= $data3['nama']; ?><br><?php if ($data3['jabatan'] != 'PPNPN') {echo $data3['nip'];} else {echo '-';}?>
        </td>
        <td style="width: 112px; text-align: center;"><?= $data3['lama_perjadin'] ?>
        </td>
        <td style="width: 151px; text-align: center;">
          Rp. <?= number_format($data3['tarif_per_hari'], 0, ",", "."); ?>
        </td>
        <?php
        $kali_per_hari = $data3['lama_perjadin'] * $data3['tarif_per_hari'];
        ?>
        <td style="width: 157px; text-align: center;">Rp. <?= number_format($kali_per_hari, 0, ",", "."); ?></td>
...
<table style=" height: 5px; width: 812px; float: left;">
  <tbody>
    <tr style="height: 22px;">
      <td style="width: 309px; height: 22px;">Setuju dibebankan pada mata anggaran berkenaan :</td>
      <td style="width: 22px; height: 22px;">&nbsp;</td>
      <td style="width: 209px; height: 22px;">&nbsp;</td>
      <td style="width: 23px; height: 22px;">&nbsp;</td>
      <td style="width: 309px; height: 22px;">Lunas dibayar tanggal......</td>
    </tr>
    <tr style="height: 21px;">
      ...
      <td style="width: 24px; height: 21px;">&nbsp;</td>
      <td style="width: 309px; height: 21px;">Bendahara Pengeluaran</td>
    </tr>
    <tr style="height: 3px;">
    ...
    <tr style="height: 3px;">
      ...
      <td style="width: 209px; height: 3px;">&nbsp;</td>
      <td style="width: 23px; height: 3px;">&nbsp;</td>
      <td style="width: 309px; height: 3px;"><?php
    ...
    <tr style="height: 3px;">
      <td style="width: 309px; height: 3px;">NIP. <?= $nip_ppk; ?></td>
      <td style="width: 22px; height: 3px;">&nbsp;</td>
      <td style="width: 209px; height: 3px;">&nbsp;</td>
      <td style="width: 123px; height: 3px;">&nbsp;</td>
      <td style="width: 309px; height: 3px;">NIP. <?php
                                                    $sql = "SELECT * from pegawai where jabatan='Bendahara Pengeluaran'";
                                                    $query = mysql_query($sql);
                                                    $data1 = mysql_fetch_array($query);
