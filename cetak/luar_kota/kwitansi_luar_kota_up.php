...
<tbody>
<tr style="height: 13px;">
<td style="width: 200; height: 13px;">Sudah Terima uang dari</td>
<td style="width: 25px; height: 13px;">:</td>
<td style="width: 547px; height: 13px;" colspan="3">Kuasa Pengguna Anggaran</td>
</tr>
<tr style="height: 13px;">
<td style="width: 200px; height: 13px;">Jumlah Uang</td>
<td style="width: 25px; height: 13px;">:</td>
<td style="width: 647px; height: 13px;" colspan="3">Rp. <?php echo $kwitansi; ?></td>
</tr>
<tr style="height: 13px;">
<td style="width: 200px; height: 13px;">Terbilang</td>
<td style="width: 25px; height: 13px;">:</td>
<td style="width: 647px; height: 13px;" colspan="3"><?php echo terbilang($kwitansi2); ?> rupiah</td>
</tr>
...
<td style="width: 175; height: 22px;">&nbsp;</td>
<td style="width: 25px; height: 22px;">&nbsp;</td>
<td style="width: 259px; height: 22px;"><?= $nama_petugas_pl; ?></td>
</tr>
<tr style="height: 22px;">
<td style="width: 231px; height: 22px;">&nbsp;</td>
<td style="width: 232px; height: 22px;">&nbsp;</td>
<td style="width: 175; height: 22px;">&nbsp;</td>
<td style="width: 25px; height: 22px;">&nbsp;</td>
<td style="width: 259px; height: 22px;">NIP. <?= $nip_petugas_pl; ?></td>
</tr>
</tbody>
</table>
